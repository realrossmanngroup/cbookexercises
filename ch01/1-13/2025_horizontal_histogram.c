...
10. how do we figure out what to set shortestword word to?

largest word can be set dynamically in real time, since it
starts at a natural of 0.

however, shortestword word would be a tough one. think this
...
1. THEN THE FOR LOOP TO MAKE shortestword EQUAL TO THE SMALLEST WORD

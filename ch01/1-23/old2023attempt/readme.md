...
1-23_delete_v21.c is me updating my string detection after realizing it was off in a future program. I need to update the debugoutput to output the proper variables now since it only putsout stringliteral rather than stringliteral, charliteral, and areweinastring. do this later. 

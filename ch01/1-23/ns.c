        ...
        { /*if we out of a comment, do the following*/
            ...
            while (comment[a][y] != '\0' && y < MAXLINELENGTH - 1)
            {
                ...
                if (comment[a][y] != '/' && comment[a][y + 1] != '*')
                {
                    ...
                    {                                                     /* Go to next line & stop processing once you find a single line comment, the "//" */
                        w = IN;                                           /* we have entered a single line comment*/
                        a++;                                              /* go to next line*/
                        x = y = 0;                                        /*reset x & y to 0 to resync & realign the comment & nocomment char array copying */
                        w = OUT;                                          /*we are now out of the single line comment*/
